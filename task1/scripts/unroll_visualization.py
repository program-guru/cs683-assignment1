...
unroll_df = unroll_df.sort_values('matrix_size')
...
unroll_df['mpki'] = (
    unroll_df['l1d_misses'] * 1000
) / unroll_df['instructions']
...
comparison_df['unroll_mpki'] = unroll_df['mpki'].values

comparison_df['naive_misses'] = naive_df['l1d_misses'].values
comparison_df['unroll_misses'] = unroll_df['l1d_misses'].values

comparison_df['naive_instructions'] = naive_df['instructions'].values
comparison_df['unroll_instructions'] = unroll_df['instructions'].values

comparison_df['speedup'] = unroll_df['speedup'].values
